...
public interface SysYListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SysYParser#mainFuncDef}.
	 * @param ctx the parse tree
	 */
	void enterMainFuncDef(SysYParser.MainFuncDefContext ctx);
	/**
	 * Exit a parse tree produced by {@link SysYParser#mainFuncDef}.
	 * @param ctx the parse tree
	 */
	void exitMainFuncDef(SysYParser.MainFuncDefContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SysYParser#forStmt}.
	 * @param ctx the parse tree
	 */
	void enterForStmt(SysYParser.ForStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link SysYParser#forStmt}.
	 * @param ctx the parse tree
	 */
	void exitForStmt(SysYParser.ForStmtContext ctx);
	/**
