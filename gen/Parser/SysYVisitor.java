...
public interface SysYVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SysYParser#mainFuncDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMainFuncDef(SysYParser.MainFuncDefContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SysYParser#forStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForStmt(SysYParser.ForStmtContext ctx);
	/**
